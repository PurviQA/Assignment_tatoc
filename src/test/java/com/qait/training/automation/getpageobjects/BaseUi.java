...
import static com.qait.training.automation.getpageobjects.ObjectFileReader.getPageTitleFromFile;
...
import com.qait.training.automation.utils.SeleniumWait;
...
public class BaseUi {
	 WebDriver driver;
	    ...
	    protected void addCookie(Cookie ck)
	    {
